...
run = dict(
    ...
    # Exchange flow
    Exchangeflow_1=[0.6, 0.5/0.6, None],
    Exchangeflow_2=[0.75, 0.5/0.75, None],
    Exchangeflow_3=[0.9, 0.5/0.9, None])
...
for name, (r, Hm, Fr) in run.items():
    ...
    #exchange
    U_initial = np.zeros(nz)  
    U0 = U_initial * np.ones((nx, nz))          
